...
public class ChecklistItemControllerTest {
    ...
    private ChecklistItemDTO getChecklistItemDTO(String description, Boolean isCompleted, LocalDate dateEnd,
                                                 String categoryName){
    ...
    private ChecklistItemEntity getChecklistItemEntity(Long id, String description, Boolean isCompleted, LocalDate dateEnd,
        ...
        entity.setDatePost(LocalDate.now());
        return entity;
    }
    ...
    public void shouldCallGetAllChecklistItemsAndReturn200() throws Exception {
        ...
        when(checklistItemService.findAllChecklistItens()).thenReturn(findAllData);
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/checklist-items"))
                ...
                .andExpect(jsonPath("$[0].dateEnd").value("2021-10-01"))
                .andExpect(jsonPath("$[0].datePost").isNotEmpty())
                ...
                .andExpect(jsonPath("$[1].dateEnd").value("2021-10-02"))
                .andExpect(jsonPath("$[1].datePost").isNotEmpty())
